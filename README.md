...
・このソースコードをダウンロードします。  
    ...
    git clone git://github.com/white-mns/sola_rails.git
...
あとは[解析プログラム](https://github.com/white-mns/sola_parse)側に結果ファイルを用意し、解析とアップロード機能を追加してデータを入れれば新しい解析項目が公開されます。
